...
export const metadata: Metadata = {
  ...
  description:
    "国会議員の活動スコアランキング。立法活動・投票行動・政策影響力・透明性・質問品質の5軸で議員のパフォーマンスを可視化。選挙区で検索してあなたの地域の議員を調べましょう。",
  openGraph: {
    title: "議員活動ランキング | GiinScore - 国会議員の活動スコアを可視化",
    description:
      "国会の公開データに基づく議員の活動量ランキング。5軸スコアで「口先だけの議員」と「実際に成果を出している議員」を客観的に比較できます。",
  },
  twitter: {
    card: "summary_large_image",
    title: "議員活動ランキング | GiinScore",
    description:
      "国会議員の活動スコアランキング。選挙区で検索してあなたの地域の議員の実力を確認しましょう。",
  },
};
