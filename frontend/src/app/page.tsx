...
import { getMockRanking, getMockStats } from "@/lib/mock-data";
...
export default function HomePage() {
  ...
  const filtered = chamber === "all"
    ? ranking
    : ranking.filter((r) => r.member.chamber === chamber);
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-sm text-slate-500">第213回国会における議員の活動スコアランキング</p>
      </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base">TOP {filtered.length}</CardTitle>
        </CardHeader>
